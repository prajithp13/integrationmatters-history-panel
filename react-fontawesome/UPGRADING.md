...
As always, [submit issues](https://github.com/FortAwesome/react-fontawesome/issues/new) that you run into with this
guide or with these upgrades to us.
...
_All packages are in
the [@fortawesome NPM scope](https://www.npmjs.com/search?q=scope:fortawesome&page=1&ranking=optimal)_
...
If you were previously relying on Font Awesome to replace any `<i>` tags in your page or app with `<svg>` you'll need to
explicitly control that now.
